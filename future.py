...
#########-----------changed-----------
    ...
    def focal_loss(gamma=2., alpha=None):
        def focal_loss_fixed(y_true, y_pred):
            ...
            y_true_onehot = K.one_hot(y_true, num_classes=y_pred.shape[-1])
            ...
            if alpha is not None:
                ...
                alpha_weight = y_true_onehot * alpha_tensor
                focal = alpha_weight * weight * cross_entropy
            else:
...
#########--------------------------------
    ...
    # LSTM model (via KerasClassifier)
    ...
    #    model.add(Dense(4, activation='softmax'))  # 4 breakdown codes
    ...
    def build_nn_model():
        ...
        alpha_weights = [1.0, 15.0, 15.0, 15.0]  # Code 0 gets less weight
